...
#SBATCH --output=/sonic_home/igor.viveiros/paralelo/logs/fin-predlen-%A_%a.out
#SBATCH --error=/sonic_home/igor.viveiros/paralelo/logs/fin-predlen-%A_%a.err
...
# Não inclui 20 porque você já tem esse exercício.
PRED_LENS=(1 5 10 15)
