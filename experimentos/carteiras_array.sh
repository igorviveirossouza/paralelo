...
#SBATCH --gres=gpu:1
#SBATCH --array=0-269%6
#SBATCH --time=48:00:00
#SBATCH --job-name=carteiras_log
#SBATCH --output=/sonic_home/igor.viveiros/paralelo/logs/0carteiras_log-%A_%a.out
#SBATCH --error=/sonic_home/igor.viveiros/paralelo/logs/0carteiras_log-%A_%a.err
...
EXPERIMENTO="meu_multi_lb_predlen_todos_ativos"
